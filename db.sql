...
INSERT INTO `livros` (`id_livro`, `titulo`, `status_livro`, `autor`, `categoria`, `paginas`, `estado_livro`, `imagem`, `comentarios`) VALUES
	...
	(30, 'O Príncipe de Maquiavel: Texto Integral', 'Disponível', 'Nicolau Maquiavel', 'Teoria e Crítica Literária', 96, 'Excelente', '/imagemLivros/imagem_2023-10-09_100301466.png', 'Teste da adição do livro ao acervo.');
