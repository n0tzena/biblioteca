...
CREATE TABLE IF NOT EXISTS `emprestimo` (
  ...
  `id_cpf_aluno` varchar(255) NOT NULL,
  ...
  KEY `id_usuario` (`id_cpf_aluno`) USING BTREE,
  CONSTRAINT `FK_emprestimo_aluno` FOREIGN KEY (`id_cpf_aluno`) REFERENCES `aluno` (`cpf`),
...
-- Copiando dados para a tabela sistema_gerencial_biblioteca.livros: ~2 rows (aproximadamente)
